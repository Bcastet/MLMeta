...
def get_match_history(continent: Continent = None, region: Region = None, platform: Platform = None, puuid: str = None, start: int = None, count: int = None, start_time: arrow.Arrow = None, end_time: arrow.Arrow = None, queue: Queue = None, type: MatchType = None):
    return MatchHistory(continent=continent, region=region, platform=platform, puuid=puuid, start=start, count=count, start_time=start_time, end_time=end_time, queue=queue, type=type)
